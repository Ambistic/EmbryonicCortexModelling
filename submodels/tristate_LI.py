...
class TriStateLIModelFactory:
    def __init__(self,
                 ...
                 diff_values_RG_GP=[0., 0., 0., 0.2, 0.4], # prob GP vs IP
        ...
        def diff_func_tristate_LI(time_, type_, brain, gpn_id, ngbs=[]):
            if type_ == CellTypeGP.RG:
                ...
                if np.random.random() < val:
                    ...
                    val2 = lin_diff_RG_GP(time_)
                    return choice([CellTypeGP.GP, CellTypeGP.IP], 1, p=[val2, 1 - val2])[0]
